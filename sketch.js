...
function draw() {
    ...
    if(mousePressedOver(login)) {
      ...
      if(mousePressedOver(login2)) {
        ...
        this.Teacheruser = createInput("Username")
        this.Teacherpass = createInput("password")
        this.Teacherbutton = createButton('Login');

        this.Teacheruser.position(displayWidth/2 - 40 , displayHeight/2 - 80);

  
        this.Teacherpass.position(displayWidth/2 - 40 , displayHeight/2 - 50);
  
        this.Teacherbutton.position(displayWidth/2 + 30, displayHeight/2);
        debugger;
        this.Teacherbutton.mousePressed(()=>{

          this.Teacheruser.visible = false;
          this.Teacherpass.hide();
